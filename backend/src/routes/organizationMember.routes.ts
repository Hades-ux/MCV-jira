...
import { addOrganiztionMemberController, deleteOrganizationMemberController } from '../controllers/organiztionMember.controller.js';
...
router.delete('/delete-member',jwtMiddleware,deleteOrganizationMemberController)
